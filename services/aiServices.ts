...
function mockAskQuestionResponse(request: AskData): Promise<AskQuestionResponse> {
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve(`Đây là câu trả lời mẫu cho câu hỏi: "${request.question}". Trong môi trường thực tế, AI sẽ phân tích và trả lời câu hỏi của bạn một cách chi tiết.`);
